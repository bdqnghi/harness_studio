...
Runs the current harness once per practice task and reports which failed. These
scores *locate failures only* — they make no keep/reject decision (that is the
gate's job, with precision reserved for it).
"""
