...
lost instead of rediscovering it. After each acceptance decision we distill one
...
def distill(
    ...
    *, model: str | None = None,
    ...
    """The <=200-word lesson from testing one hypothesis at the acceptance."""
    ...
    prompt = (
        ...
        f"AcceptanceCheck verdict: {verdict} (judging gain {decision.gain:+.3f}, "
